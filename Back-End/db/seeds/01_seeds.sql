...
VALUES (1, 'Inuyasha POP Figure', 20, 'DO NOT pay more than $30 for it!', 'https://www.amazon.ca/Funko-Pop-Animation-Inuyasha/dp/B07YQH31DD/ref=sr_1_12?keywords=inuyasha+nendoroid&qid=1637364283&sr=8-12', 1, TRUE),
       (1, 'Books', 10, 'Any mystery or horror book. I like Stephen King. Hardcover please!', null, 4, TRUE),
       (1, 'Shampoo', 5, 'Any scent works (except vanilla)', null, 3, FALSE),
...
INSERT INTO gifters (name, email)
VALUES ('Sam', 'Sam@gmail.com'),
       ('Lacey', 'Laceyisrich@gmail.com'),
       ('Bob', 'bob@hotmail.com');

INSERT INTO selected_gifts (gifter_id, gift_id, selected_quantity)
VALUES (1, 3, 2),
       (1, 1, 1),
       (2, 2, 3),
       (2, 5, 1),
